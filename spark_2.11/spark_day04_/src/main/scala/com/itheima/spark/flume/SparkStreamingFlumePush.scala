...
object SparkStreamingFlumePush {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /**
      ...
      * hostname: String,  //todo Streaming aplication运行的主机ip
      * port: Int,        //todo  接收数据的端口  任意写不冲突就行
      * storageLevel: StorageLevel = StorageLevel.MEMORY_AND_DISK_SER_2
      * ): ReceiverInputDStream[SparkFlumeEvent]
      */
    val inputFlumeDStream: ReceiverInputDStream[SparkFlumeEvent] = FlumeUtils.createStream(
      ssc,
      "10.254.6.197",
      9999,
